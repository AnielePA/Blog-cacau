  ...
  return (
    <footer className='footer-container' id='footer'>
      <div className='footer-cacao-icon'>
        <img src={cacauIlustracao} alt='Ilustração de cacau' />
      </div>
      ...
      >
        <section className='footer-section-contato'>
          <h3>Conecte-se com a Cacauron!</h3>
        ...
        <section className='footer-section-logo'>
          <div className='footer-logo'>
            <img src={logoCacauron} alt='Logo Cacauron' />
            <p>
              Cacauron - Associação dos Cacauicultores e Chocolateiros de
              Rondônia
            </p>
          </div>
        </section>
      ...
      <div className='footer-copyright'>
        © {new Date().getFullYear()} Cacauron. Todos os direitos reservados.
        {cnpjEmpresa && (
          <>
